// 最後編輯 2019-5-03 by ShinWei Chiou
...
const float R1 = 200;      // 200Kohm, The Voltage devider resistor R1
const float R2 = 100;      // 100Kohm, The Voltage devider resistor R2
...
void setup()
{
  ...
  String aeg_name;
  aeg_name = "AEG-" + aeg_address.substring(0, 2) + aeg_address.substring(3, 5);
